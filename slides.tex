...
\author[Theile]{Henrik-Alexander Schubert\inst{1} \& Johann Behrendt}

\institute[MPIDR]{\inst{1}Wissenschaftlicher Mitarbeiter am \textit{Max-Planck-Institut für Demografische Forschung}}
...
%
%% Hansa
%\textsc{\begin{frame}[mpidrbackground = 4]
...
%===========================================================================
\section{Die historische Bev\"olkerungsentwicklung}
...
\begin{frame}
    \frametitle{Bevölkerungsveränderungen in den Stadtteilen}
           \begin{figure}
               \centering
                \vspace{-10pt}
...
\begin{figure}
        \vspace{-10pt}
        \centering
       \includegraphics[height=7cm]{figures/events_districts_zoom.pdf}
   \end{figure}
\end{frame}

%===========================================================================
\section{Die Bev\"olkerungsstruktur in der Gegenwart}
...
\begin{frame}
\frametitle{Geografie der Alterung}
    \begin{figure}
        \vspace{-10pt}
...
%===========================================================================
\section{Die Bev\"olkerung in der Zukunft}

\begin{frame}
	\frametitle{Die offizielle Bev\"olkerungsprognose}
	\begin{figure}
		\centering
		    \vspace{-10pt}
		\includegraphics[height = 7cm]{Figures/projection_pop_size.pdf}
	\end{figure}
\end{frame}

\begin{frame}
	\frametitle{Die Hansestadt Rostock wird altern}
	\begin{figure}
		\centering
		    \vspace{-10pt}
		\includegraphics[height = 7cm]{Figures/projection_pop_change_relative.pdf}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		    \vspace{-10pt}
		\includegraphics[height = 7cm]{Figures/projection_change_arrows.pdf}
	\end{figure}
\end{frame}

\begin{frame}
	\frametitle{Die Erwerbsstruktur bleibt konstant}
	\begin{figure}
		\centering
		    \vspace{-10pt}
		\includegraphics[height = 7cm]{Figures/projection_dependency_ratio.pdf}
	\end{figure}
\end{frame}
    ...
    \begin{columns}
          \column{0.5\textwidth}
           ...
           Henrik-Alexander Schubert\\ \vspace{0.3cm}
            ...
            Wissenschaftlischer Mitarbeiter \\ \vspace{0.15cm}
